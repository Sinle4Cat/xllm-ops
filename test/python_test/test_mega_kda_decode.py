...
@pytest.mark.parametrize("mode,capacity", [(0, 1), (1, 1), (1, 2), (1, 4), (1, 8), (1, 16)])
...
def assert_native(data, actual, input_snapshots=None):
...
@pytest.mark.parametrize("mode,capacity", [(0, 1), (1, 1), (1, 2), (1, 4), (1, 8), (1, 16)])
@NPU_TEST
def test_native_graph_changed20_carry20(mode, capacity):
    data = make_case(capacity=capacity, mode=mode)
    ops, actual = npu_case(data)
    for _ in range(3):
        ops.mega_kda_decode(**actual)
