...
namespace ops {
static ge::graphStatus InferShapeMegaKdaPrefill(gert::InferShapeContext* context)
{
...
static ge::graphStatus InferDataTypeMegaKdaPrefill(gert::InferDataTypeContext* context)
{
...
IMPL_OP_INFERSHAPE(MegaKdaPrefill)
    .InferShape(InferShapeMegaKdaPrefill).InferDataType(InferDataTypeMegaKdaPrefill);
} // namespace ops
