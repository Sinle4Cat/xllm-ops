...
namespace optiling {
BEGIN_TILING_DATA_DEF(MegaGdnNativePrefillTilingData)
...
TILING_DATA_FIELD_DEF(int64_t, conv_slot_stride);
TILING_DATA_FIELD_DEF(int64_t, ssm_slot_stride);
END_TILING_DATA_DEF;

REGISTER_TILING_DATA_CLASS(MegaGdnNativePrefill,
                           MegaGdnNativePrefillTilingData)
}  // namespace optiling
