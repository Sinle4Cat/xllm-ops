...
#error "MegaGdnNativePrefill requires exactly one target architecture family"
#endif
...
#error "A2/A3 MegaGdnNativePrefill must compile for the C220 architecture"
#endif
#if defined(GDN_PREFILL_ARCH_A5) && (__NPU_ARCH__ != 3510)
#error "A5 MegaGdnNativePrefill must compile for the C3510 architecture"
#endif
#endif
