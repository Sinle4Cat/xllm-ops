...
struct MegaGdnNativePrefillKernelTilingData {
    uint32_t block_dim;
    ...
    GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    REGISTER_TILING_DEFAULT(MegaGdnNativePrefillKernelTilingData);
    GET_TILING_DATA_WITH_STRUCT(MegaGdnNativePrefillKernelTilingData,
                                tiling_data, tiling);
    ...
    gdn_prefill_frontend::RunConv(
        ...
        batch_size, tiling_data.conv_state_len, tiling_data.conv_slot_stride);
    ...
    qwen35_e2e_pto::mega_kernel_impl<true, true, true, true, true, true>(
        ...
        static_cast<int64_t>(tiling_data.ssm_state_slots), tiling_data.ssm_slot_stride);
